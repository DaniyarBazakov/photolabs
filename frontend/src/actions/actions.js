// Define constants for action types to avoid typos and improve maintainability
export const ACTIONS = {
  FAV_PHOTO_ADDED: 'FAV_PHOTO_ADDED',         // Action type for adding a photo to favourites
  FAV_PHOTO_REMOVED: 'FAV_PHOTO_REMOVED',     // Action type for removing a photo from favourites
